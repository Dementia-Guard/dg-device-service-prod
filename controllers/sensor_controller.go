...
func GetHourlySensorData(c *gin.Context) {
	...
	if err != nil {
		utils.ErrorResponse(c, http.StatusInternalServerError, err.Error(), "403")
		return
	}
	utils.SuccessResponse(c, http.StatusOK, "Hourly Sensor Data Retrieved", "SUCCESS", data)
}
...
func GetDailySensorData(c *gin.Context) {
	...
	utils.SuccessResponse(c, http.StatusOK, "Daily Sensor Data Retrieved", "SUCCESS", data)
}
...
func GetWeeklySensorData(c *gin.Context) {
	...
	utils.SuccessResponse(c, http.StatusOK, "Weekly Sensor Data Retrieved", "SUCCESS", data)
}
...
func GetMonthlySensorData(c *gin.Context) {
	...
	utils.SuccessResponse(c, http.StatusOK, "Monthly Sensor Data Retrieved", "SUCCESS", data)
}
...
func GetSpecificDateSensorData(c *gin.Context) {
	...
	if dateStr == "" {
		utils.ErrorResponse(c, http.StatusBadRequest, "Date parameter is required", "400")
		return
	}
	...
	if err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, "Invalid date format, use YYYY-MM-DD", "400")
		return
	}
	...
	if err != nil {
		utils.ErrorResponse(c, http.StatusInternalServerError, err.Error(), "500")
		return
	}

	utils.SuccessResponse(c, http.StatusOK, "Sensor Data Retrieved for Specific Date", "SUCCESS", data)
}
